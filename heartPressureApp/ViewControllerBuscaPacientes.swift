//
//  ViewControllerBuscaPacientes.swift
//  heartPressureApp
//
...
class ViewControllerBuscaPacientes: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    func saveResults(documentName : String!){
        ...
        db.collection("pacientes").document(documentName).setData([
            "Sistolica": [
            date : sist
            ],
            "Distolica": [
  ...
  /*   override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "muestra"{
            ...
            //vistaJug. = listaNombres[indexPath.row]
        }
        else {
